...
public class CreatorCachedValuesLab {
    ...
    //milling
    private boolean mIsMillingHssDrill;
    private Material mMillingMaterial;
    ...
    private CreatorCachedValuesLab(Context context){
        mContext = context;
    }

    public static CreatorCachedValuesLab getCachedValuesLab(Context context) {
        if (sCachedValuesLab == null)
            sCachedValuesLab = new CreatorCachedValuesLab(context.getApplicationContext());
    ...
    public boolean isMillingHssDrill() {
        return mIsMillingHssDrill;
    }

    public void setMillingHssDrill(boolean millingHssDrill) {
